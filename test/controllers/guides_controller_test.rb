...
class GuidesControllerTest < ActionController::TestCase
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post :create, guide: { category_id_id: @guide.category_id_id, name: @guide.name, user_id_id: @guide.user_id_id }
    end
  ...
  test "should update guide" do
    patch :update, id: @guide, guide: { category_id_id: @guide.category_id_id, name: @guide.name, user_id_id: @guide.user_id_id }
    assert_redirected_to guide_path(assigns(:guide))
  end
